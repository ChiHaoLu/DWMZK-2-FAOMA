...
void FAOMA_1_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void FAOMA_1_run(uint ctx_index,Circom_CalcWit* ctx);
...
ctx->componentMemory[coffset].templateName = "FAOMA";
ctx->componentMemory[coffset].signalStart = soffset;
